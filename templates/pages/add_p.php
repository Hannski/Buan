...
<div class="row d-flex justify-content-center">
	...
	<div class=" h-25 m-1 input-group d-flex align-items-center">
		...
		<?php
		echo "<input class=\"form-control col-md-12 col-xs-12 col-lg-12\" type=\"text\"  name=\"p_preis\" placeholder=".$langArray[$opt]['Platzh_P_preis'].">";
		?>
	</div>
	<div class=" h-25 m-1 input-group d-flex align-items-center">
		<div class="input-group mb-3">
<!-- Dynamische Sprchinformation fuer das inputfeld je nach Sprachwahl. siehe auch:Bootstrap.CSS-> Dokumentenkopf -->
  <div class="custom-file  lang ="<?php echo $opt ?>">
